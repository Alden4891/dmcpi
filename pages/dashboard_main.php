...
<?php
    ...
    $res_toptile = mysqli_query($con,"
        ...
        ,(SELECT SUM(Amt_Due) AS collection FROM installment_ledger WHERE YEAR(date_encoded)=$prev_year) AS prev_collection
        ,(SELECT SUM(Amt_Due) AS collection FROM installment_ledger WHERE YEAR(date_encoded)=$current_year) AS curr_collection"
    );
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>Active </p>
                            </td>
                            <td>97%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>Passed due </p>
                            </td>
                            <td>2%</td>
                          </tr>
                          <tr>
        ...
        {
            {
                ...
                function (data)
                {
                    ...
                    for (var i in data[0]) {
                        ...
                        amounts.push(data[0][i].amount);
                    }
                    for (var i in data[1]) {
                        periods2.push(data[1][i].period);
                        amounts2.push(data[1][i].amount);
                    }
