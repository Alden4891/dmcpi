...
$pdf->SetFont('Times','',8);   
$pdf->AddCol('Branch_Name',28,'BRANCH','L');
$pdf->AddCol('Branch_Head',28,'BRANCH HEAD','L');
$pdf->AddCol('Agent_name',30,'AGENT','L');
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>0);
$pdf->Table($con,"call sp_soo_byagent($year,$month);",$prop);
